...
export const trainingController2 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "2y", label: "1-2 year" },
      { id: "3y", label: "2-3 years" },
      { id: "4y", label: "3-4 years" },
      { id: "5y", label: "4-5 years" },
      { id: "6y", label: "5-7 years" },
      { id: "7y", label: "7-10 years" },
      { id: "7y", label: "10+ years" },
...
export const trainingController3 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "3", label: "At least 1 Recommendation required" },
      { id: "5", label: "At least 2 Recommendation required" },
      { id: "6", label: "At least 3 Recommendation required" },
    ],
  },
];
