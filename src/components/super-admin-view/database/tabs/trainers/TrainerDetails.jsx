...
const TrainerDetails = ({ trainer, areApprovalBtnsVisible = false }) => {
  ...
  const pdfFiles = Object.entries(pdfObject).reduce((acc, [customKey]) => {
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-4 gap-4 mt-4">
          <div className="p-4 rounded-lg border border-gray2">
            ...
            <span className="text-gray1/50">8 YOE</span>
          </div>
          ...
          <div className="p-4 rounded-lg border border-gray2">
            ...
            <span className="text-gray1/50 inline-block">
              Frontline team Trainings
            </span>
            <span className="text-gray1/50 inline-block">
          ...
          <div className="p-4 rounded-lg border border-gray2">
            ...
            <span className="text-gray1/50 inline-flex items-center gap-2">
              <PhoneCallIcon className="w-4" /> +919300030336
            </span>
            <span className="text-gray1/50 inline-flex items-center gap-2">
              <MailIcon className="w-4" />
              <span className="truncate w-40">margarhetcher@gmail.com</span>
            </span>
          </div>
          ...
          <div className="p-4 rounded-lg border border-gray2">
            ...
            <span className="text-gray1/50">456 Oak Avenue, Anytown, USA</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 pb-6">
        ...
        <div className="px-6 pb-6 grid grid-cols-2 gap-8">
          <div>
            ...
            {trainer?.otherDetails?.map((detail) => (
              <div
                key={detail.label}
                className="flex gap-8 border-b border-gray2 py-2 text-sm"
              >
          ...
          <div>
            <div>
              <h2 className="text-lg font-semibold mt-4">Expertise Areas</h2>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3 mt-2">
                {trainer?.trainingImages?.length > 0 ? (
                  ...
                  <span className="text-gray-500">No training images</span>
                )}
              </div>
            </div>
          </div>
