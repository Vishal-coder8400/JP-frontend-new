        ...
        <div className="p-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
              ...
              {/* Latest Qualification Box */}
              <div className="h-48 flex flex-col p-[16px] gap-[12px] rounded-[8px] border-[#DBE0E5] border-[1px]">
                <div className="flex items-center gap-[12px]">
                  <div>
                    <BookOpen className="w-5 h-5 text-[#121417]" />
                  </div>
                  <div className="text-[#121417] text-sm font-semibold">
                  ...
                  {displayRecruiter?.latestQualification ? (
                    <div className="flex flex-col items-center gap-2 w-full">
                      <iframe
                        ...
                        className="w-full h-24 border-none rounded-sm"
                      />
                      <button
                        onClick={() => window.open(displayRecruiter.latestQualification, "_blank")}
                    ...
                    <div className="text-[#61758A] text-sm font-normal text-center">
                      No qualification document available
                    </div>
                  )}
                </div>
              </div>
