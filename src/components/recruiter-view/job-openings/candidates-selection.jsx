                      ...
                      <div className="flex items-center gap-[10px]">
                        ...
                        >
                          {item?.profilePicture ? (
                            ...
                            <div className="flex items-center justify-center h-full w-full rounded-full bg-[#6945ED] text-white font-bold text-sm">
                    ...
                    <TableCell className="px-[16px] py-[12px]">
                      <div className="self-stretch justify-start text-[#35353A] text-sm font-normal leading-tight">
                        {item?.currentAddress?.city 
                          ? `${item.currentAddress.city}, ${item.currentAddress.state}`
                          : "N/A"}
                      </div>
                    </TableCell>
                    <TableCell className="px-[16px] py-[12px]">
                    ...
                    {show && (
                      <TableCell className="w-[50px] px-[16px] py-[12px]">
                        <Checkbox
                          onCheckedChange={() => handleSelect(item._id)}
                          checked={selectedSeeker?.includes(item._id)}
                          className="data-[state=checked]:text-white data-[state=checked]:bg-[#6945ED] h-[20px] w-[20px] rounded-[2px] flex items-center justify-center cursor-pointer"
                        />
                      </TableCell>
                    )}
                    <TableCell className="px-[16px] py-[12px]">
