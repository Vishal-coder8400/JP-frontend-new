...
const navigate = useNavigate();
  ...
  const debouncedSearch = useDebounce(searchText, 500);
   const stageRoutes = {
    1: "/trainer/profile-setup/basic-details",
    2: "/trainer/profile-setup/education-details",
    3: "/trainer/profile-setup/working-details",
    4: "/trainer/profile-setup/certificate-details",
    5: "/trainer/profile-setup/additional-details",
  };

  const currentStage = Number(trainerProgressData?.data?.currentStage);
  const nextStagePath = stageRoutes[currentStage];


console.log("Stage =", currentStage);
console.log("Next =", nextStagePath);
